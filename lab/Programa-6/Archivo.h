...
void Archivo::calculateInfoXAndY( vector<double> vAllXValues, vector<double> vAllYValues, int iNumberOfPairs ){
	...
	double fSumXValuesAux = 0;
	double fSumYValuesAux = 0;
	double fSumSquaredXValuesAux = 0;
	double fSumSquaredYValuesAux = 0;
	double fSumXtimesYValuesAux = 0;
	...
	this -> fSumSquaredXValues = fSumSquaredXValuesAux;
	this -> fSumSquaredYValues = fSumSquaredYValuesAux;
	this -> fSumXtimesYValues = fSumXtimesYValuesAux;
