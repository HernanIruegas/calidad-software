...
class Calculo {
	...
	public:
		...
		double calculateP( Respuesta* pObj );
		double calculateF( int iDof, double dXAux );

};

//_i
double Calculo::calculateGamma( double dAux ){
...
//_i
double Calculo::calculateP( Respuesta* pObj ){
...
//_i
double Calculo::calculateF( int iDof, double dXAux ){
